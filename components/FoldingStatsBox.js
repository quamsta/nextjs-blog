...
export default function FoldingStatsBox({ foldingStats }) {
  return (
    <Box>
      <h2 className={`${boxStyles.boxHeading}`}>
        My <a href="https://foldingathome.org">Folding@Home</a> Stats
      </h2>
      <div className={boxStyles.boxContent}>
        <p className="mt-0">
          <strong>Username:</strong>{" "}
          <a
            href={"https://stats.foldingathome.org/donor/" + foldingStats.name}
          >
            {foldingStats.name}
          </a>{" "}
          <br />
          ...
          <strong>Last work unit uploaded:</strong>{" "}
          <FoldingDate dateString={foldingStats.last} />
          <br />
